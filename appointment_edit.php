...
<html>
    ...
    <body>
        ...
        <div style="padding:10px">
            ...
            <div><input type="text" id="name" name="phone" value="<?php echo $event['appointment_patient_phone'] ?>" /></div>
            <div>Email: </div>
            <div><input type="text" id="name" name="email" value="<?php echo $event['appointment_patient_email'] ?>" /></div>
            <div>Keluhan: </div>
            <div><input type="text" id="name" name="keluhan" value="<?php echo $event['appointment_patient_keluhan'] ?>" /></div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $("#save").click(function() {
                    ...
                    appointment.phone = $("#phone").val();
                    appointment.email = $("#email").val();
                    appointment.keluhan = $("#keluhan").val();
