									...
									<ul class="nav navbar-nav">
										...
										<li class="dropdown" class="active"> <a data-toggle="dropdown" href="#">SERVICES</a>
											<ul class="dropdown-menu with-bg" role="menu">
												...
												<li class="active"><a href="services6.php">Implants</a></li>
	...
	<div class="container">
		<div class="row">
				...
				<div class="doctor-info">
					<div class="crowns-info-image" align="center"> <img src="images/implants.jpg" alt="" /> </div>
				</div>
			
			<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">	
				<div class="doctor-text">
					<br>
					<h3>Apa itu Dental Implants?</h3>
					<p style="text-align: justify;">Implan gigi adalah alternatif yang paling mungkin terdekat dengan penggantian gigi yang sebenarnya. Dengan perawatan yang tepat, perawatan, dan kunjungan pemeriksaan rutin dengan dokter gigi Anda, implan gigi dirancang untuk bertahan seumur hidup.

					Sebuah implan standar dapat digunakan untuk mengganti satu gigi, atau dua implan dapat ditempatkan untuk membuat jembatan tanpa mempengaruhi gigi di sekitarnya. Banyak orang dengan implan tidak bisa membedakan antara gigi alami dan implan mereka, dan juga tidak bisa teman dan keluarga mereka!</p>
