				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown active"> <a data-toggle="dropdown" href="#">SERVICES</a>
						<ul class="dropdown-menu with-bg" role="menu">
							...
							<li><a href="services9.php">Dentures</a></li>
						</ul>
					</li>
					<li class="dropdown"> <a data-toggle="dropdown" href="#">Dokter</a>
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									...
									<ul class="nav navbar-nav">
										...
										<li class="dropdown" class="active"> <a data-toggle="dropdown" href="#">SERVICES</a>
											<ul class="dropdown-menu with-bg" role="menu">
												<li class="active"><a href="services.php">Oral exams</a></li>
												<li><a href="services1.php">Teeth whitening</a></li>
												<li><a href="services2.php">Teeth cleaning</a></li>
												<li><a href="services3.php">X-rays</a></li>
												<li><a href="services4.php">Crowns</a></li>
		...
		<div class="row">
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="doctor-info">
					<div class="oralexams-info-image"> <img src="images/oralexams.jpg" alt="" /> </div>
				</div>
			</div>
			<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">	
				<div class="doctor-text">
					<h3>Apa itu Dental (Oral) Exam?</h3>
					<p style="text-align: justify;">Oral exam yang biasa disebut pemeriksaan gigi, adalah proses yang digunakan oleh dokter gigi untuk meninjau kesehatan mulut secara hati-hati. Ujian lisan biasanya melibatkan seluruh mulut, sebagai komponen kunjungan pertama kali atau pemeriksaan rutin 6 bulan. Ujian lisan juga dapat digunakan untuk mengidentifikasi masalah spesifik di satu area mulut tertentu, seperti nyeri, pembengkakan, patah gigi, atau masalah gigi lainnya.</p>
					<h3>Apa langkah-langkah dari Dental (Oral) Exam?</h3>
					<p>Ada empat kategori utama Dental (Oral) Exam:<br>
					<ul class="text-list">
						<li><b><p style="text-align: justify;">Evaluasi Oral Komprehensif:</b> Pemeriksaan lisan komprehensif diperlukan bagi pasien yang melihat dokter gigi baru untuk pemeriksaan pertama kali, atau jika sudah lama sejak kunjungan terakhir.</p></li>
						<br>
						<li><b><p style="text-align: justify;">Evaluasi Oral Reguler (Periodik) :</b> Reguler exams adalah bagian dari proses pemeriksaan gigi 6 bulan. Ujian lisan periodik adalah update lengkap dari informasi yang sudah ada untuk pasien mapan yang secara teratur mengunjungi kantor. Pemeriksaan berkala mungkin atau mungkin tidak termasuk sinar-X, tergantung kapan mereka terakhir dikonsumsi, jika dokter gigi mengamati suatu masalah yang mungkin memerlukan sinar-x, atau jika pasien masuk untuk pemeriksaan dengan rasa sakit atau gejala lainnya.
 						<br>
 						<br>
						Selama evaluasi oral berkala atau komprehensif, dokter gigi Anda akan meninjau radiograf Anda (sinar-X), melakukan pemeriksaan visual, dan mencari pembengkakan, pendarahan, kantong periodontal, dan kalkulus (penumpukan) di sekitar dan di bawah garis gusi. Dia akan memeriksa bagian luar dan dalam dari mulut, lidah, dan jaringan lunak lainnya, dan akan memberi tahu Anda jika mereka melihat sesuatu yang mungkin merupakan tanda peringatan potensial kanker mulut atau kondisi lainnya. Dalam beberapa kasus, dokter gigi Anda mungkin mengarahkan Anda ke dokter Anda untuk masalah tertentu.

						Dokter gigi Anda mungkin menggunakan penjelajah untuk memeriksa gigi dan gusi Anda, termasuk pekerjaan yang ada yang mungkin Anda miliki seperti tambalan, jembatan, dan mahkota. Jika Anda memiliki gigi tiruan penuh atau parsial, dokter gigi Anda akan meminta Anda untuk menghapusnya untuk pemeriksaan. Pada pemeriksaan dokter gigi Anda akan menanyakan apakah ada yang mengganggu Anda. Ini adalah saat yang tepat untuk memberi tahu dokter gigi Anda jika Anda memperhatikan gejala atau ada pertanyaan atau kekhawatiran tentang kesehatan mulut atau senyum Anda pada umumnya.</p></li>
						<br>
						<li><b><p style="text-align: justify;">Evaluasi Oral Terbatas: </b>jenis ujian ini juga dikenal sebagai "masalah fokus." Ini digunakan untuk mengidentifikasi dan mendiagnosis gejala seperti sakit gigi, atau pembengkakan di daerah mulut tertentu. Ujian terbatas mungkin melibatkan sinar-X digital di daerah yang terkena dan pembacaan diagnostik oleh dokter gigi, serta evaluasi visual. Dokter gigi Anda akan mengajukan pertanyaan yang berkaitan dengan gejala Anda.</p></li>
						<br>
						<li><b><p style="text-align: justify;">Evaluasi Lanjutan: </b>Dokter gigi Anda mungkin meminta Anda untuk kembali mengikuti kunjungan lanjutan untuk memeriksa penyembuhan dan kemajuan untuk jenis pengobatan tertentu yang diberikan, atau jika Anda mengalami rasa sakit atau gejala lain di luar apa yang biasanya diharapkan.</p></li>
					</ul>
					</p>
				</div>
			</div>
