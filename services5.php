<?php 
    ...
    include('header.php');
    open_page('Fillings and bridges'); 
									...
									<ul class="nav navbar-nav">
										...
										<li class="dropdown" class="active"> <a data-toggle="dropdown" href="#">SERVICES</a>
											<ul class="dropdown-menu with-bg" role="menu">
												...
												<li class="active"><a href="services5.php">Fillings and bridges</a></li>
	...
	<div class="container">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Fillings and Bridges</li>
			</ol>
		</div>
	</div>
</div>
		...
		<div class="row">
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="doctor-info">
					<div class="cleaning-info-image"> <img src="images/fillings.jpg" alt="" /> </div>
				</div>
			</div>
			<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">	
				<div class="doctor-text">
					<h3>Fillings</h3>
					<p style="text-align: justify;"><b>Apa itu Dental Fillings?</b><br>

					Tambalan gigi(Fillings) merupakan pilihan pengobatan untuk membantu mengembalikan fungsi dan tampilan gigi yang rusak atau busuk. Tambalan gigi(Fillings) yang paling umum digunakan untuk merawat rongga. Memiliki gigi "terisi" adalah prosedur yang sangat umum dan bisa diselesaikan dalam satu janji di kantor. </p>
					
					
					<h3>Bridges</h3>
					<p style="text-align: justify;"><b>Apa itu Dental Bridges? </b> <br>
					Bridges adalah salah satu dari sedikit pilihan yang Anda miliki untuk mengganti gigi yang hilang. Gigi palsu ini secara harfiah menjembatani celah itu dengan berlabuh ke gigi alami di kedua sisinya. Mereka mungkin 100% keramik atau porselen menyatu dengan logam untuk menunjang fungsi normal mulut.

					Seperti mahkota, jembatan biasanya mengambil dua kunjungan untuk menyelesaikannya. Selama kunjungan pertama, para ahli di Guba Dental membentuk gigi abutment sehingga ujung jembatan sesuai dengan kenyamanan masing-masing. Kami juga memberi kesan untuk mengirim ke lab gigi tempat jembatan Anda akan dibuat. Kami kemudian akan memberi Anda jembatan sementara sehingga Anda bisa melakukan aktivitas normal Anda.

					Kira-kira dua minggu kemudian, kita ganti dengan jembatan permanen; Maka kita tersenyum indah, fungsional,dan sepenuhnya dipulihkan.
