                ...
                <div class="text-center">
                  ...
                  <label>
                    <h4>
                      ...
                      Rp <?php echo'<input type="text" value="'.$biaya.'" id="totalPembayaran" class="input-sm" name="totalPembayaran">';?>
                    </h4>
                  </label>
                  </div>
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    Maaf Kupon anda tidak valid/tidak ada/sudah dipakai sebelumnya.
                  </div>
                  <label>
                  <div class="text-center">
