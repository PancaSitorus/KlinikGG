...
<body>
 ...
 <form action="process1.php" method="post" class="center">
  <div class="container">
                ...
                <div class="text-center">
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <label>
                      <h4>
                        ...
                        ?>
                        Selamat, kupon berhasil diterapkan.<br>
                        <span class="bold700">Biaya Perawatan :</span> 
                          &nbsp Rp <?php echo'<input type="text" value="'.$biaya.'" name="biaya" class="input-sm" onChange="cekHarga(this.value)">'; ?>
                        </h4>
                      </label><br>
                  </div>
                  <?php 
                  ...
                  <label>
                    <h4>
                      ...
                      Rp <?php echo'<input type="text" value="'.$total.'" id="totalPembayaran" class="input-sm" name="totalPembayaran">';?>
                    </h4>
                  </label>
                  </div>
                  <div class="text-center">
