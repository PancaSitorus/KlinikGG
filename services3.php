									...
									<ul class="nav navbar-nav">
										...
										<li class="dropdown" class="active"> <a data-toggle="dropdown" href="#">SERVICES</a>
											<ul class="dropdown-menu with-bg" role="menu">
												...
												<li class="active"><a href="services3.php">X-rays</a></li>
		...
		<div class="row">
			<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">	
				<div class="doctor-text">
					<h3>Dental X-Rays</h3>
					<p style="text-align: justify;">X-ray gigi merupakan bagian penting dari proses diagnostik untuk kesehatan mulut. Ada beberapa jenis X-ray yang mungkin diperlukan untuk kunjungan Anda. Berikut adalah kategori utama X-ray:</p>
			
					<ul>
						<li><b><p style="text-align: justify;">Full Mouth Series: </b> Juga dikenal sebagai "set lengkap" X-ray, rangkaian mulut penuh biasanya terkait dengan Oral Exams yang komprehensif. Rangkaian X-ray ini menangkap seluruh mulut dan digunakan untuk membangun kesehatan mulut dan baseline orisinal atau awal. Sela penuh X-ray adalah kombinasi sinar X "bitewing" dan "periapical," atau "PA".</p></li>
						
						<li><b><p style="text-align: justify;">Bitewing X-Rays: </b> X-ray ini menunjukkan gigi belakang atas dan bawah dalam satu tampilan. Hal ini memungkinkan dokter gigi untuk melihat bagaimana mereka saling bersentuhan dan berbaris. Jenis X-ray ini juga memungkinkan dokter gigi Anda untuk melihat kerusakan, kehilangan tulang, penyakit gusi, atau kemungkinan infeksi.</p></li>
						
						<li><b><p style="text-align: justify;">Periapical X-Rays: </b>Tunjukkan seluruh gigi, dari mahkota yang terbuka sampai ujung akar dan tulang yang menopang gigi. X-ray ini digunakan untuk menemukan masalah gigi di bawah garis gusi atau di rahang, seperti gigi, abses, kista, tumor, dan perubahan tulang yang terkait dengan beberapa penyakit.</p></li>
						
						<li><b><p style="text-align: justify;">Checkup (Periodic) X-Rays: </b>Disebut juga sebagai "recall" X-ray, ini adalah kombinasi dari sinar X biteling dan periapikal. X-ray ini biasanya diperbarui sesuai kebutuhan saat dikombinasikan dengan kunjungan pemeriksaan rutin.</p></li>
						
						<li><b><p style="text-align: justify;">Limited or problem-focused X-rays: </b>Ini biasanya kombinasi X-ray bitewing dan periapikal yang terfokus pada area tertentu untuk membantu mendiagnosis masalah tertentu, atau diambil selama prosedur jika diperlukan.</p></li>
						
						<li><b><p style="text-align: justify;">Panoramic X-Ray: </b>Juga disebut sebagai "pano" atau "panoramic", jenis X-ray ini biasanya digunakan untuk jenis perawatan atau diagnostik tertentu. X-ray panoramic menunjukkan seluruh mulut termasuk rahang, gigi, sinus, daerah hidung, dan sendi temporomandibular (TMJ), dalam satu gambar. X-ray panorama sering dikaitkan dengan diagnosis masalah gigi kebijaksanaan, konsultasi ortodontik, konsultasi implan dan operasi mulut, atau mungkin direkomendasikan oleh dokter gigi jika ada masalah yang mencegah penganiayaan standar atau X-ray periapikal.</p></li>
					</ul>
					<h3>Bagaimana dental x-ray bekerja?</h3>
					<p style="text-align: justify;">X-ray yang melewati mulut mereka sebagian besar diserap oleh gigi dan tulang karena jaringan-jaringan, yang disebut jaringan keras, lebih padat dari pipi dan gusi, yang disebut jaringan lunak. Ketika X-ray pemogokan film atau sensor digital, gambar yang disebut radiograf yang dibuat. Radiografi memungkinkan dokter gigi untuk melihat kelainan tersembunyi, seperti infeksi kerusakan gigi, dan tanda-tanda penyakit gusi, termasuk perubahan dalam tulang dan ligamen gigi.</p>
			</div>
		</div>
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="doctor-info">
					<div class="cleaning-info-image"> <img src="images/x-ray.jpg" alt="" /> </div>
				</div>
			</div>
		</div>
	</div>
