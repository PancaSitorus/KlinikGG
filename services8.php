									...
									<ul class="nav navbar-nav">
										...
										<li class="dropdown" class="active"> <a data-toggle="dropdown" href="#">SERVICES</a>
											<ul class="dropdown-menu with-bg" role="menu">
												...
												<li class="active"><a href="services8.php">Root canals</a></li>
	...
	<div class="container">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Root Canals</li>
			</ol>
		</div>
	</div>
</div>
