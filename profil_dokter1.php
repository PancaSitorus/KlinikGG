...
<br>
	...
	<div class="nav_bar">
		<ul>
			<li><a href="profil_dokter1.php"id="onlink">Profil Dokter</a></li>
		...
		<div class="row">
			<div class="right-bar col-lg-4 col-md-4 col-sm-4 col-xs-12">
					...
					<div class="doctors-item">
						<div class="doctors-item-container"><center>
							<div class="doctors-item-image"> <img src="images/dokter_1.jpg" alt="" /> </div>
			...
			<div class="blog-container col-lg-7 col-md-7 col-sm-7 col-xs-12">
				<div class="doctor-text">
					<div class="doctor-text-quote"> “Karena mencegah adalah lebih baik daripada mengobati” <i>-Arif</i>
						<div class="doctor-text-quote-quote"><img src="images/quote.png" alt="" /></div>
					</div>
					<h3>PENDIDIKAN</h3>
					<ul class="text-list">
						<li>Drg dari Institut Tekonologi Del. Indonesia</li>
						<li>M.S.C. dari Institut Teknologi Del. Indonesia</li>
						<li>P. H.D. dari Institut Teknologi Del. Indonesia</li>
					</ul>
					<h3>PENGALAMAN</h3>
					<p>Arif telah bekerja selama 10 tahun di klinik ini. Merupakan dokter yang sudah berpengalaman dalam dunia keddokteran gigi. Sebelumnya pernah bekerja disuatu klinik perusaahaan swasta, bank, dan lain sebagainya.</p>
					<h3>Sertifikat dan Penghargaan</h3>
					<ul class="text-list">
						<li>Seminar Kesehatan Gigi Internasional dari Institut Teknologi Bandung. Indonesia
						</li>
						<li> Wisudawan Terbaik 2 Pasca Sarjana dari Institut Teknologi Del. Indonesia
						</li>
