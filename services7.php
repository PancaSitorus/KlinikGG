									...
									<ul class="nav navbar-nav">
										...
										<li class="dropdown" class="active"> <a data-toggle="dropdown" href="#">SERVICES</a>
											<ul class="dropdown-menu with-bg" role="menu">
												...
												<li class="active"><a href="services7.php">Extractions</a></li>
		...
		<div class="row">
			<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">	
				<div class="doctor-text">
					<h3>Apa itu Extractions?</h3>
					<p style="text-align: justify;">Ekstraksi gigi adalah menghilangkan gigi. Jika saraf gigi telah mati atau gigi telah terinfeksi sangat parah, pencabutan merupakan satu-satunya cara. Pencabutan gigi bisa dilakukan dengan cara yang sederhana ataupun pencabutan yang rumit.
						<br>
						Ekstraksi gigi merupakan proses pencabutan atau pengeluaran gigi dari tulang alveolus, dimana pada gigi tersebut sudah tidak dapat dilakukan perawatan lagi. Pencabutan gigi juga merupakan operasi bedah yang melibatkan jaringan bergerak dan jaringan lunak dari rongga mulut, akses yang dibatasi oleh bibir dan pipi, dan selanjutnya dihubungkan disatukan oleh gerakan lidah dan rahang

					</p>
			
					
					<h3> Faktor-faktor Tidak Dapat Dilakukannya Ekstraksi Gigi</h3>
					<p style="text-align: justify;">Pencabutan gigi terkadang tidak bisa dilakukan karena berbagai faktor, diantaranya sebagai berikut:
						<ul>
						<li><p style="text-align: justify;">kelainan sistemik, seperti diabetes melitus, hipertensi, leukemia yang tidak terkontrol, kehamilan, dan kelainan perdarahan</p></li>
						<li><p style="text-align: justify;">kelainan lokal, seperti perikoronitis akut, oedem berat, abses dentoalveolar akut, dan sebagainya</p></li>
					</ul>
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="doctor-info">
					<div class="cleaning-info-image"> <img src="images/extraction.jpg" alt="" /> </div>
				</div>
			</div>
		</div>
	</div>
