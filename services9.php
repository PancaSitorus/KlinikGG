<?php 
    ...
    include('header.php');
    open_page('Surgical implant placements'); 
									...
									<ul class="nav navbar-nav">
										...
										<li class="dropdown" class="active"> <a data-toggle="dropdown" href="#">SERVICES</a>
											<ul class="dropdown-menu with-bg" role="menu">
												...
												<li class="active"><a href="services9.php">Surgical implant placements</a></li>
											</ul>
										</li>
		...
		<div class="row">
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="doctor-info">
					<div class="cleaning-info-image"> <img src="images/dentures.jpg" alt="" /> </div>
				</div>
			</div>
			<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">	
				<div class="doctor-text">
					<h3>Apa itu Dentures</h3>
					<p style="text-align: justify;">Dentures merupakan gigi tiruan lepasan yang terbuat dari resin akrilik atau kombinasi resin akrilik-logam untuk menggantikan gigi yang telah hilang.</p>
					
					
					<h3>Kapan harus menggunakan dentures?</h3>
					<p style="text-align: justify;">
Bila anda kehilangan satu atau lebih gigi anda, denture dapat dijadikan opsi yang dapat mengembalikan fungsi pengunyahan dan bicara anda, serta dapat memberbaiki penampilan dan senyum anda.

					</p>
					<h3>Macam-macam dentures</h3>
					<ul>
						<li><b><p style="text-align: justify;">Partial Denture: </b> cocok untuk anda yang hanya kehilangan satu atau beberapa gigi dan ingin memperbaiki senyum, kemampuan bicara dan mengunyah anda. Ada beberapa macam bahan partial denture, di antaranya: akrilik, logam atau valplast (flexi denture).</p></li>
						<li><b><p style="text-align: justify;">Full Denture: </b> cocok untuk yang banyak kehilangan gigi / kehilangan semua gigi asli anda. Dapat dikombinasikan dengan implant untuk menambah kestabilan denture.</p></li>
